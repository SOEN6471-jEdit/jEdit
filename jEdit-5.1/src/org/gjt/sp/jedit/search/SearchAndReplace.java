...
loop:		for(;;)
	...
	{
		return Replace.replaceAll(view,false);
	} //}}}
	...
	{
		return Replace.replaceAll(view, dontOpenChangedFiles);
	} //}}}
	...
	//{{{ record() method
	static void record(View view, String action,
